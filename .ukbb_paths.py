...
PHENOTYPE_DATASET_CSV_FILE_PATH = os.path.join(BASE_DIR, 'ukb52255.csv')
...
FAM_FILE_PATH = os.path.join(GENETICS_DIR, 'ukb22418_c1_b0_v2_s488139.fam')
...
CALL_DIR = os.getenv('CALL_DIR', os.path.join(
    GENETICS_DIR, 'EGAD00010001226/001'))
...
KINSHIP_TABLE_FILE_PATH = os.path.join(
    GENETICS_DIR, 'ukb_rel_a85474_s488139.dat')
...
GENETICS_DESCRIPTION_FILE_PATH = os.path.join(
    BASE_DIR, 'ukb_genetic_file_description.txt')
...
TMP_DIR_FOR_RAW_MARKER_LINKS = '/home/hdo/BIM-BED-FAM'
